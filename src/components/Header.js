    ...
    <nav className=" bg-deep-cove-600 flex  px-8 pt-2 shadow-md lg:justify-center items-center py-2">
      <div className="relative select-none bg-grey lg:flex lg:items-stretch w-full">
        <div className="flex flex-no-shrink items-stretch h-12">
          <Link
            to="/"
            className="flex-no-grow flex-no-shrink relative py-2 sm:px-6 text-lg font-bold leading-normal text-white no-underline flex items-center hover:bg-grey-dark"
          >
            WikiGhibli
          </Link>
